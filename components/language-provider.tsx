...
const translations = {
  bg: {
    home: 'Начало', shop: 'Магазин', about: 'За нас', contact: 'Контакти', cart: 'Количка', menu: 'Меню', market: 'Пазар', language: 'Език', close: 'Затвори', remove: 'Премахни', emptyCart: 'Количката ви е празна.', toShop: 'Към магазина', summary: 'Обобщение', subtotal: 'Междинна сума', shipping: 'Доставка', free: 'Безплатно', checkout: 'Продължи към плащане', send: 'Изпрати', sending: 'Изпращане...', unavailable: 'Покупката във Великобритания е временно недостъпна', unavailableShort: 'UK покупка недостъпна', available: 'Налични', size: 'Размер', quantity: 'Количество', details: 'Детайли', returns: 'Връщане', payment: 'Плащане', delivery: 'Доставка', shopCollection: 'Разгледай колекцията', buyNow: 'Купи сега', freeShipping: 'Безплатна доставка до България и поддържаните държави от ЕС • До 2 работни дни', stockError: 'Избраният продукт няма достатъчна наличност.', imageSoon: 'Снимка предстои'
  },
  en: {
    home: 'Home', shop: 'Shop', about: 'About', contact: 'Contact', cart: 'Cart', menu: 'Menu', market: 'Market', language: 'Language', close: 'Close', remove: 'Remove', emptyCart: 'Your cart is empty.', toShop: 'Continue shopping', summary: 'Summary', subtotal: 'Subtotal', shipping: 'Shipping', free: 'Free', checkout: 'Proceed to checkout', send: 'Send', sending: 'Sending...', unavailable: 'UK checkout is currently unavailable', unavailableShort: 'UK purchase unavailable', available: 'Available', size: 'Size', quantity: 'Quantity', details: 'Details', returns: 'Returns', payment: 'Payment', delivery: 'Delivery', shopCollection: 'Explore collection', buyNow: 'Buy now', freeShipping: 'Free shipping to Bulgaria and supported EU countries • Up to 2 business days', stockError: 'The selected product does not have enough stock.', imageSoon: 'Image coming soon'
  }
} as const
