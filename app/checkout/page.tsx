...
export default function Checkout() {
  ...
  const marketUnavailable = market === 'UK' && items.some((item) => item.product.priceGbpMinor == null)

  async function submit(event: FormEvent<HTMLFormElement>) {
    event.preventDefault(); if (marketUnavailable) { setMessage('UK checkout is currently unavailable until GBP prices are configured.'); return } setLoading(true); setMessage('')
